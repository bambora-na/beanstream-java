...
public class PaymentAPITest {
	...
	public void Return() throws BeanstreamApiException {
		...
		if (response.isApproved()) {
			response = beanstream.payments().Return(response.id, 90.0,response.order_number);
	...
	public void unreferencedCardReturn() throws BeanstreamApiException {
            ...
            unrefCardReturnRequest.amount = 100.00;
            unrefCardReturnRequest.merchant_id = "300200578";
            unrefCardReturnRequest.order_number = getRandomOrderId("GAS");
